...
goals = [
  ...
  gerrymandering_fed = g.add_node("Federal Laws for\nGerrymandering", URL: 'https://democraticredistricting.com/', target: 'new'),
  gerrymandering_state = g.add_node("State Laws for\nGerrymandering", URL: 'https://democraticredistricting.com/', target: 'new'),
  ec_pact = g.add_node("National\nPopular Vote\nInterstate Compact", URL: "https://www.nationalpopularvote.com/written-explanation", target: 'new'),
